...
import { ArrowLeft, ArrowRight, BookOpen, Eye, EyeOff, GraduationCap, HeartHandshake, KeyRound } from 'lucide-react';
...
export default function OnboardingPage({ navigate }) {
  ...
  const [form, setForm] = useState({ name: '', email: '', password: '', confirm: '', grade: '', school: '', country: 'Jamaica', couponCode: '' });
