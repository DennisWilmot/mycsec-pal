  ...
  return <div className="landing">
    <section className="hero">
      <header className="public-nav container">
        ...
        <nav><a href="#subjects">Subjects</a><a href="#how">How It Works</a><a href="#pricing">Beta access</a><button className="text-button" onClick={()=>navigate('practice')}>Sign In</button><button className="button dark small" onClick={()=>navigate('onboarding')}>Join the beta <ArrowRight size={16}/></button></nav>
      </header>
